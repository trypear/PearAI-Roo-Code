...
// Create a proper React component for the toggleable button
const ToggleableButtonExample = () => {
	const [toggled, setToggled] = React.useState(false)
	return (
		<Button onToggle={(newToggled) => setToggled(newToggled)} toggled={toggled}>
...
export const ToggleableButton: Story = {
	render: () => <ToggleableButtonExample />,
}
