...
export const VSC_LIST_SELECTION_BACKGROUND_VAR = "--vscode-list-activeSelectionBackground"
export const VSC_FOCUS_BORDER = "--vscode-focus-border"
export const VSC_LIST_ACTIVE_FOREGROUND_VAR = "--vscode-quickInputList-focusForeground"
...
export const HeaderButton = styled.button<{
	...
	&:hover {
		background-color: ${({ inverted, hoverBackgroundColor }) =>
			typeof inverted === "undefined" || inverted ? (hoverBackgroundColor ?? vscInputBackground) : "transparent"};
	}
	display: flex;
	align-items: center;
