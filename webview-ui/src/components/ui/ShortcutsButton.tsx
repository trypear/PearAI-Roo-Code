...
import { lightGray, vscEditorBackground, vscForeground } from "./index"
...
const StyledShortcutButton = styled.div<{ offFocus: boolean }>`
	...
	border: 1.5px solid ${(props) => (props.offFocus ? undefined : lightGray + "33")};
	border-radius: 6px;
`
...
export function ShortcutButton({ keys, onClick, offFocus = false, label, labelInside = false }: ShortcutButtonProps) {
	return (
